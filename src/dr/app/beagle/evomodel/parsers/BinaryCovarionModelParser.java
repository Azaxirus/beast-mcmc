...
public class BinaryCovarionModelParser extends AbstractXMLObjectParser {
    public static final String COVARION_MODEL = dr.oldevolmodelxml.substmodel.BinaryCovarionModelParser.COVARION_MODEL;
    public static final String ALPHA = dr.oldevolmodelxml.substmodel.BinaryCovarionModelParser.ALPHA;
    public static final String SWITCHING_RATE = dr.oldevolmodelxml.substmodel.BinaryCovarionModelParser.SWITCHING_RATE;
    public static final String FREQUENCIES = dr.oldevolmodelxml.substmodel.BinaryCovarionModelParser.FREQUENCIES;
    public static final String HIDDEN_FREQUENCIES = dr.oldevolmodelxml.substmodel.BinaryCovarionModelParser.HIDDEN_FREQUENCIES;
    public static final String VERSION = dr.oldevolmodelxml.substmodel.BinaryCovarionModelParser.VERSION;
    public static final dr.oldevomodel.substmodel.BinaryCovarionModel.Version DEFAULT_VERSION =
            dr.oldevolmodelxml.substmodel.BinaryCovarionModelParser.DEFAULT_VERSION;
